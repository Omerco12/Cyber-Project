...
from create_dataset import start_capture, move
...
class PageThree(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        self.addperson.grid(row=1, column=2, ipadx=5, ipady=4, padx=10, pady=20)
    ...
    def capimg(self):
        ...
        move(self.controller.active_name)
        augment(self.controller.active_name)
